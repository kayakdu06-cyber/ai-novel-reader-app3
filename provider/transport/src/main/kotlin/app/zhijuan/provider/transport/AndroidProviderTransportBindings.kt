...
class EncryptedProviderTransportDiagnosticSink(
    ...
    private fun ProviderProtocol.toDiagnosticProtocol(): DiagnosticProtocol = when (this) {
        ProviderProtocol.OPENAI_RESPONSES -> DiagnosticProtocol.OPENAI_RESPONSES
        ProviderProtocol.OPENAI_CHAT_COMPAT -> DiagnosticProtocol.OPENAI_CHAT_COMPATIBLE
        ProviderProtocol.ANTHROPIC_MESSAGES -> DiagnosticProtocol.ANTHROPIC_MESSAGES
        ProviderProtocol.GEMINI_GENERATE_CONTENT -> DiagnosticProtocol.GEMINI_GENERATE_CONTENT
        ProviderProtocol.OLLAMA_NATIVE,
        ProviderProtocol.OLLAMA_OPENAI_COMPAT,
        -> DiagnosticProtocol.OLLAMA
    }
