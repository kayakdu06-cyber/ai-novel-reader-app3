...
class RegistryBackedAnthropicCapabilityResolverTest {
    @Test
    fun `adapter resolver applies a model scoped registry override`() = runBlocking {
        val profile = ProviderConnectionProfile.create("c1", ProviderProtocol.ANTHROPIC_MESSAGES, "https://api.example/v1")
        ...
        val result = RegistryBackedAnthropicCapabilityResolver(registry)
    ...
    private companion object {
        ...
        const val VERSION = "anthropic-messages-1"
    }
}
