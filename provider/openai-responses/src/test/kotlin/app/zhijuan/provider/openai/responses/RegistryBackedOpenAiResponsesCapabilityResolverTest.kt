...
class RegistryBackedOpenAiResponsesCapabilityResolverTest {
    @Test
    fun `adapter resolver applies a model scoped registry override`() = runBlocking {
        val profile = ProviderConnectionProfile.create("c1", ProviderProtocol.OPENAI_RESPONSES, "https://api.example/v1")
        ...
        val result = RegistryBackedOpenAiResponsesCapabilityResolver(registry)
